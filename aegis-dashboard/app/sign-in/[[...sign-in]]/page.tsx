  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 bg-white border-r border-slate-200 px-12 py-10">
        ...
        <div>
          <p className="text-2xl font-semibold text-slate-900 leading-snug mb-8">
            Your AWS security posture,<br />
            <span className="text-emerald-600">fixed — not just reported.</span>
          </p>
          <div className="space-y-4">
            {[
              'Full IAM, S3, EC2, and VPC audit',
              'CIS AWS Foundations compliance score',
              'One-click remediation with human approval',
              'Verification pass after every fix',
            ].map(item => (
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm text-slate-500 text-center mt-6">
            ...
            <Link href="/sign-up" className="text-emerald-600 hover:underline font-medium">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
